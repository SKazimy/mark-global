...
exports.onContactFormSubmission = exports.submitContactForm = void 0;
...
const createTransporter = () => {
    ...
    functions.logger.info("Email config:", {
        ...
        passLength: ((_a = config.auth.pass) === null || _a === void 0 ? void 0 : _a.length) || 0,
    });
...
const getAdminEmailTemplate = (name, email, message, timestamp) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
// Firestore trigger - fires when a new contact form submission is created (backup)
exports.onContactFormSubmission = functions.firestore
    ...
    const transporter = createTransporter();
    const adminEmail = process.env.ADMIN_EMAIL || "info@themarkglobal.co.in";
    const timestamp = (createdAt === null || createdAt === void 0 ? void 0 : createdAt.toDate().toLocaleString("en-IN", {
        timeZone: "Asia/Kolkata",
        dateStyle: "full",
        timeStyle: "short",
    ...
    try {
        ...
        functions.logger.error("Error sending email - Full error:", JSON.stringify(error, Object.getOwnPropertyNames(error)));
        functions.logger.error("Error message:", error instanceof Error ? error.message : "Unknown");
